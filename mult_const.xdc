...
set_property PACKAGE_PIN W6 [get_ports {SS[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SS[5]}]

set_property PACKAGE_PIN U8 [get_ports {SS[4]}]
...
set_property PACKAGE_PIN U5 [get_ports {SS[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SS[2]}]

set_property PACKAGE_PIN V5 [get_ports {SS[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SS[1]}]

set_property PACKAGE_PIN U7 [get_ports {SS[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SS[0]}]

set_property PACKAGE_PIN W4 [get_ports {AA[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {AA[3]}]

set_property PACKAGE_PIN V4 [get_ports {AA[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {AA[2]}]

set_property PACKAGE_PIN U4 [get_ports {AA[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {AA[1]}]

set_property PACKAGE_PIN U2 [get_ports {AA[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {AA[0]}]
